...
int main( )
{
       ...
       // LOAD image
       image = imread("/home/riotu/catkin_ws/src/ros_essentials_cpp/src/topic03_perception/images/chess.jpg",1);   // Read the file "image.jpg".
       ...
       //DISPLAY image
       namedWindow( "window", 1); // Create a window for display.
